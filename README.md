...
- Remove duplicate results, and prioritize specific services for a given file.
...
Outside of the configuration page, the behavior of this addon can also be changed with environment variables.  
